...
interface StepService {
    ...
    fun <TWorkflowModel> findSteps(workflow: Workflow<TWorkflowModel>, query: Query<StepQueryable, StepQueryable>): Page<Step>
    fun findSteps(query: Query<StepQueryable, StepQueryable>): Page<Step>
