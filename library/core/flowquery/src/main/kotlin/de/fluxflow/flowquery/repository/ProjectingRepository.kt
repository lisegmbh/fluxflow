...
interface ProjectingRepository<TRoot> {
    ...
    companion object {
         ...
         */
        inline fun <reified TRoot, TResult> ProjectingRepository<TRoot>.find(
            resultType: Class<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): List<TResult> {
            return find(resultType, builder(FlowQuery.of()))
        }
         ...
         * @return a list of results matching the built query
         */
        inline fun <reified TRoot, TResult : Any> ProjectingRepository<TRoot>.find(
            resultType: KClass<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): List<TResult> {
         ...
         * @throws NoSuchElementException if no result is found
         */
        inline fun <reified TRoot, TResult> ProjectingRepository<TRoot>.findFirst(
            resultType: Class<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>
        ): TResult {
            return findFirst(resultType, builder(FlowQuery.of()))
        }
         ...
         * @throws NoSuchElementException if no result is found
         */
        inline fun <reified TRoot, TResult : Any> ProjectingRepository<TRoot>.findFirst(
            resultType: KClass<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>
        ): TResult {
         ...
         * @return the first matching result, or `null` if none found
         */
        inline fun <reified TRoot, TResult> ProjectingRepository<TRoot>.findFirstOrNull(
            resultType: Class<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): TResult? {
            return findFirstOrNull(resultType, builder(FlowQuery.of()))
        }
         ...
         * @return the first matching result, or `null` if none found
         */
        inline fun <reified TRoot, TResult : Any> ProjectingRepository<TRoot>.findFirstOrNull(
            resultType: KClass<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): TResult? {
         ...
         * @throws IllegalStateException if more than one result is found
         */
        inline fun <reified TRoot, TResult> ProjectingRepository<TRoot>.findSingle(
            resultType: Class<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): TResult {
            return findSingle(resultType, builder(FlowQuery.of()))
        }
         ...
         * @throws IllegalStateException if more than one result is found
         */
        inline fun <reified TRoot, TResult : Any> ProjectingRepository<TRoot>.findSingle(
            resultType: KClass<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>
        ): TResult {
         ...
         * @throws IllegalStateException if more than one result is found
         */
        inline fun <reified TRoot, TResult> ProjectingRepository<TRoot>.findSingleOrNull(
            resultType: Class<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): TResult? {
            return findSingleOrNull(resultType, builder(FlowQuery.of()))
        }
         ...
         * @throws IllegalStateException if more than one result is found
         */
        inline fun <reified TRoot, TResult : Any> ProjectingRepository<TRoot>.findSingleOrNull(
            resultType: KClass<TResult>,
            builder: FlowQueryBuilder<TRoot, TResult>,
        ): TResult? {
