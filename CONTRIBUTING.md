...
- **Review the [documentation](https://docs.fluxflow.cloud/)** before opening a new issue.
...
If you are actively searching for an issue to work on, look for issues labeled with [good first issue](https://github.com/lisegmbh/fluxflow/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
Keep in mind that support is especially needed for issues assigned to [the current milestone](https://github.com/lisegmbh/fluxflow/milestones).
...
- **Update the CHANGELOG** for all enhancements and bug fixes. Include the corresponding issue number if one exists, and your GitHub username. (example: "- Fix activation error when restoring from MariaDB. #123 @yourgithub")

- **Use the repo's default branch.** Branch from and submit your pull request to the repo's default branch (currently `develop`).
...
Readability is the most important. Following the existing style, formatting, and naming conventions of the file you are modifying and of the overall project. Failure to do so will result in a prolonged review process that has to focus on updating the superficial aspects of your code, rather than improving its functionality and performance.
